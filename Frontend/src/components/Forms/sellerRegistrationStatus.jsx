    ...
    return(<div className="min-h-screen flex justify-center items-center ">
        ...
        <ol className="relative text-gray-500 border-s border-gray-200 dark:border-gray-700 dark:text-gray-200">                  
            <li className="mb-10 ms-6">            
                ...
                <h3 className="font-medium leading-tight">Registration</h3>
                <p className="text-sm">submit registration form</p>
            </li>
            <li className="mb-10 ms-6">
                ...
                <h3 className="font-medium leading-tight">Verification</h3>
                <p className="text-sm">verifying seller</p>
            </li>
            <li className="mb-10 ms-6">
                <span className="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -start-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                ...
                <p className="text-sm">review by managers</p>
            </li>
            <li className="ms-6">
                <span className="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -start-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                    <svg className="w-3.5 h-3.5 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                ...
                <p className="text-sm">Accept / Reject seller</p>
            </li>
        </ol>
        </div>
